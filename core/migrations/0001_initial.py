    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modoficado', models.DateField(auto_now=True, verbose_name='Atualização')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icone', models.CharField(choices=[('lni-cog', 'Engrenagem'), ('lni-stats-up', 'Gráfico'), ('lni-users', 'Usuários'), ('lni-layers', 'Deisgn'), ('lni-mobile', 'Mobile'), ('lni-rocket', 'Foguete')], max_length=12, verbose_name='Icone')),
            ],
            options={
